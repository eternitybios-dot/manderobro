...
// Double-float Mandelbrot (no fma — mobile safe). Zoom to ~1e-14.
...
void main() {
  ...
  col += exp(-0.012 * smoothI) * 0.15 * vec3(0.4, 0.9, 0.85);
...
// WebGL1 also gets double-float for deep eternal zoom.
